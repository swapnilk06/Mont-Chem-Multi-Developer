 ...
 * @since 1.0.0
 */
class genlab_widget_site_Logo extends Widget_Base {
	...
	public function get_title() {
		return __( 'Genlab - Site Logo', 'genlab' );
	}
	...
	protected function register_content_site_logo_controls() {
		...
		$this->add_responsive_control(
			'align',
			array(
				'label'              => __( 'Alignment', 'genlab' ),
				'type'               => Controls_Manager::CHOOSE,
				'options'            => array(
					'left'   => array(
						'title' => __( 'Left', 'genlab' ),
						'icon'  => 'eicon-text-align-left',
					),
					'center' => array(
						'title' => __( 'Center', 'genlab' ),
						'icon'  => 'eicon-text-align-center',
					),
					'right'  => array(
						'title' => __( 'Right', 'genlab' ),
		...
		$this->add_control(
			'caption',
			array(
				'label'       => __( 'Custom Caption', 'genlab' ),
				'type'        => Controls_Manager::TEXT,
				'default'     => '',
				'placeholder' => __( 'Enter caption', 'genlab' ),
				'condition'   => array(
					'caption_source' => 'yes',
				),
				'dynamic'     => array(
		...
		$this->add_control(
			'link_to',
			array(
				'label'   => __( 'Link', 'genlab' ),
				'type'    => Controls_Manager::SELECT,
				'default' => 'default',
				'options' => array(
					'default' => __( 'Default', 'genlab' ),
					'none'    => __( 'None', 'genlab' ),
					'file'    => __( 'Media File', 'genlab' ),
					'custom'  => __( 'Custom URL', 'genlab' ),
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'placeholder' => __( 'https://your-link.com', 'genlab' ),
				'condition'   => array(
					'link_to' => 'custom',
				),
				'show_label'  => false,
	...
	protected function register_site_logo_styling_controls() {
		...
		$this->add_control(
			...
			array(
				'label'     => __( 'Background Color', 'genlab' ),
		...
		$this->add_control(
			...
			array(
				'label'       => __( 'Border Style', 'genlab' ),
				'type'        => Controls_Manager::SELECT,
				'default'     => 'none',
				'label_block' => false,
				'options'     => array(
					'none'   => __( 'None', 'genlab' ),
					'solid'  => __( 'Solid', 'genlab' ),
					'double' => __( 'Double', 'genlab' ),
					'dotted' => __( 'Dotted', 'genlab' ),
					'dashed' => __( 'Dashed', 'genlab' ),
				),
				'selectors'   => array(
		...
		$this->add_control(
			...
			array(
				'label'     => __( 'Transition Duration', 'genlab' ),
				'type'      => Controls_Manager::SLIDER,
				'range'     => array(
					'px' => array(
						'max'  => 3,
		...
		$this->add_control(
			'hover_animation',
			array(
				'label' => __( 'Hover Animation', 'genlab' ),
