...
class genlab_widget_template extends Widget_Base {
	...
	public function get_name() {
		return 'genlab-elementor-template';
	}

	public function get_title() {
		return __( 'Genlab - Template', 'genlab' );
	}
	...
	public function get_keywords() {
		return [ 'genlab', 'elementor', 'template', 'load' ];
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			'section_general',
			[
				'label' => esc_html__( 'General', 'genlab' ),
			]
		);
		...
		$this->add_control(
			'select_template',
			array(
				'label' => esc_html__( 'Select Template', 'genlab' ),
