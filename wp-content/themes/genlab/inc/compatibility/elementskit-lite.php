...
class Awaiken_ElementsKit_Lite {
	...
	public function onboarded_status() {
		...
		if ( get_option('awaiken_default_ekit_settings') === '1' ) {
			...
			$elemkit_options[ 'module_list' ][ 'liquid-glass' ][ 'status' ] = 'inactive';
			...
			$elemkit_options[ 'widget_list' ][ 'piechart' ][ 'status' ] = 'active';
			...
			$elemkit_options[ 'widget_list' ][ 'advanced-search' ][ 'status' ] = 'inactive';
			...
			$elemkit_options[ 'module_list' ][ 'badge' ][ 'status' ] = 'inactive';
			$elemkit_options[ 'module_list' ][ 'scroll-reveal' ][ 'status' ] = 'active';
			$elemkit_options[ 'widget_list' ][ 'login-form' ][ 'status' ] = 'inactive';
			$elemkit_options[ 'widget_list' ][ 'register-form' ][ 'status' ] = 'inactive';
			$elemkit_options[ 'widget_list' ][ 'stacked-cards' ][ 'status' ] = 'inactive';
			$elemkit_options[ 'widget_list' ][ 'copyright' ][ 'status' ] = 'active';
	...
	public function admin_head_script() {
		$license_menu 	= 	apply_filters( 'genlab_theme_enable_elementskit_license_menu', false );
		$styles			=	array();
