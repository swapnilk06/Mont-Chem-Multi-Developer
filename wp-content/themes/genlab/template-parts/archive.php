...
$archive_page_layout	=	get_theme_mod( 'archive_page_layout', $GENLAB_STORAGE['archive_page_layout'] );
...
$background_image 	= get_theme_mod( 'blog_page_header_background_image', $GENLAB_STORAGE['blog_page_header_background_image'] );
if($background_image) {
								...
								<div class="post-item <?php if ( ! has_post_thumbnail() ) { echo 'no-image'; } ?>">
									...
									<div class="post-item-body">
										...
										<div class="post-item-btn">
											<?php
												printf( '<a href="%s">%s %s</a>', esc_url( $post_link ), __('Read More','genlab'), genlab_render_svg($GENLAB_STORAGE['read_more_icon']));
											?>
										</div>
									</div>
								</div>
